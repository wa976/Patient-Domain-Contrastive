...
class ASTModel(nn.Module):
    ...
    @autocast()
    def forward(self, x, y=None, y2=None, da_index=None, patch_mix=False, time_domain=False, args=None, alpha=None,training=False,return_attention_maps=False):
        """
